...
@section('content')
    <div class="bg-white text-black">
        <section class="container mx-auto max-w-lg lg:max-w-4xl p-8 h-screen grid lg:grid-cols-2 lg:gap-x-8 content-center">
            ...
            <h2 class="text-6xl mb-8">Hi, I'm Yan</h2>
            <p class="text-center text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam. </p>
        </section>
    </div>
    ...
    <div class="bg-black text-white">
        <section class="container mx-auto max-w-lg p-8 h-screen flex flex-col justify-center">
            <h2 class="text-6xl mb-8">About me</h2>
            <p class="text-center text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
    ...
    <div class="bg-white text-black">
        <section class="container mx-auto max-w-lg p-8 h-screen flex flex-col justify-center">
            <h2 class="text-6xl mb-8">Projects</h2>
            <p class="text-center text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
            <div class="flex flex-col lg:flex-row space-y-8 lg:space-y-0 justify-evenly mt-24">
    ...
    <div class="bg-black text-white">
        <section class="container mx-auto max-w-lg p-8 h-screen flex flex-col justify-center">
            <h2 class="text-6xl mb-8">Get in contact</h2>
            <p class="text-center text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
            <div class="flex flex-col lg:flex-row space-y-8 lg:space-y-0 justify-evenly mt-24">
